...
describe(solution.name + ': _', () => {
    describe('When the premium is 200 for psychologist', () => {
      ...
      it('Should zero premium for psychologist profession',
        ...
        it('Should zero premium for psychologist profession',
        () => {
          expect((solution({ profession: 'psychologist', experience: 15}, 200))).toBe(0)
        });
        it('Should zero premium for psychologist profession',
        () => {
...
describe(solution.name + ': _', () => {
    describe('When the premium is 300 for psychologist', () => {
      ...
      it('Should zero premium for psychologist profession',
        ...
        it('Should zero premium for psychologist profession',
        () => {
          expect((solution({ profession: 'psychologist', experience: 15}, 300))).toBe(0)
        });
        it('Should zero premium for psychologist profession',
        () => {
...
describe(solution.name + ': _', () => {
    describe('When the premium is 200 for therapist', () => {
      it('Should zero premium for therapist profession',
        ...
        it('Should zero premium for therapist profession',
        () => {
          expect((solution({ profession: 'therapist', experience: 11}, 200))).toBe(0)
        });
        it('Should zero premium for therapist profession',
        () => {
          expect((solution({ profession: 'therapist', experience: 20}, 200))).toBe(0)
        });
    });
  });
...
describe(solution.name + ': _', () => {
    describe('When the premium is 300 for therapist', () => {
      it('Should zero premium for therapist profession',
        ...
        it('Should zero premium for therapist profession',
        () => {
          expect((solution({ profession: 'therapist', experience: 20 }, 300))).toBe(0)
        });
    });
  });
